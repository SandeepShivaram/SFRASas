...
function updateAddressFields(newAddress, address) {
    ...
    if (address.country && address.country == 'US' && address.states && address.states.stateCode) {
        newAddress.setStateCode(address.states.stateCode);
    }
    if (address.country && address.country == 'CA' && address.states && address.states.stateCodeCA) {
        newAddress.setStateCode(address.states.stateCodeCA);
    }
